...
{
	private final CheckboxSetting forceEnglish = new CheckboxSetting("强制英语",
		"即使Minecraft设置为其他语言, 也会以英语显示Wurst客户端", true);
	
	public TranslationsOtf()
	{
		super("翻译",
			"允许Wurst中的文本以英语以外的其他语言显示, 它将使用与Minecraft相同的语言设置\n\n这是一个实验性功能！");
