...
{
	private final SliderSetting fallSpeed = new SliderSetting("降落速度", 0.125,
		0.005, 0.25, 0.005, ValueDisplay.DECIMAL);
	
	private final SliderSetting moveSpeed = new SliderSetting("移动速度", "水平移动速度",
		1.2, 1, 5, 0.05, ValueDisplay.PERCENTAGE);
	
	private final SliderSetting minHeight = new SliderSetting("最小高度",
		"当您离地面太近时不会滑行", 0, 0, 2, 0.01, ValueDisplay.DECIMAL.withLabel(0, "禁用"));
